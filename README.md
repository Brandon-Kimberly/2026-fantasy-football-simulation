...
![tests](https://img.shields.io/badge/tests-1128%20passing-brightgreen)
...
```bash
py -3.10 -m unittest discover tests      # expected: Ran 1128 tests ... OK (skipped=1, expected failures=3)
