...
![tests](https://img.shields.io/badge/tests-695%20passing-brightgreen)
...
**What makes it different:** the audit trail. **~93 findings and tracked follow-ups
...
```bash
py -3.10 -m unittest discover tests      # expected: Ran 695 tests ... OK (skipped=1, expected failures=3)
...
- **`docs/AUDIT_PLAN.md`**: the working spec, with 55 tracked follow-ups (F1-F55), each with
