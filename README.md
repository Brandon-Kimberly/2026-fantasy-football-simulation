...
![tests](https://img.shields.io/badge/tests-838%20passing-brightgreen)
...
**What makes it different:** the audit trail. **~98 findings and tracked follow-ups
across 8 audit phases: 65 fixed or built, six suspected defects measured-and-cleared, 5
...
```bash
py -3.10 -m unittest discover tests      # expected: Ran 838 tests ... OK (skipped=1, expected failures=3)
