...
![tests](https://img.shields.io/badge/tests-1326%20passing-brightgreen)
...
**What makes it different:** the audit trail. **~119 findings and tracked follow-ups
across 8 audit phases: 86 fixed or built, six suspected defects measured-and-cleared, 5
...
```bash
py -3.10 -m unittest discover tests      # expected: Ran 1326 tests ... OK (skipped=1, expected failures=3)
