...
![tests](https://img.shields.io/badge/tests-1378%20passing-brightgreen)
...
```bash
py -3.10 -m unittest discover tests      # expected: Ran 1378 tests ... OK (skipped=1, expected failures=3)
