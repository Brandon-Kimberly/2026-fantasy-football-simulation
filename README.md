...
**What makes it different:** the audit trail. **~84 findings and tracked follow-ups
across 8 audit phases: 54 fixed or built, six suspected defects measured-and-cleared, 5
...
```bash
py -3.10 -m unittest discover tests      # expected: Ran 653 tests ... OK (skipped=1, expected failures=3)
...
- **`docs/AUDIT_PLAN.md`**: the working spec, with 46 tracked follow-ups (F1-F46), each with
