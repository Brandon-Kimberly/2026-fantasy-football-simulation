...
**What makes it different:** the audit trail. **~87 findings and tracked follow-ups
...
- **`docs/AUDIT_PLAN.md`**: the working spec, with 49 tracked follow-ups (F1-F49), each with
