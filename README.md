...
![tests](https://img.shields.io/badge/tests-1286%20passing-brightgreen)
...
**What makes it different:** the audit trail. **~115 findings and tracked follow-ups
across 8 audit phases: 82 fixed or built, six suspected defects measured-and-cleared, 5
...
```bash
py -3.10 -m unittest discover tests      # expected: Ran 1286 tests ... OK (skipped=1, expected failures=3)
