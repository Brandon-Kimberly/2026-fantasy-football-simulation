...
**What makes it different:** the audit trail. **~89 findings and tracked follow-ups
...
```bash
py -3.10 -m unittest discover tests      # expected: Ran 671 tests ... OK (skipped=1, expected failures=3)
...
- **`docs/AUDIT_PLAN.md`**: the working spec, with 51 tracked follow-ups (F1-F51), each with
