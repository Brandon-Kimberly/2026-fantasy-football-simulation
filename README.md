...
![tests](https://img.shields.io/badge/tests-704%20passing-brightgreen)
...
```bash
py -3.10 -m unittest discover tests      # expected: Ran 704 tests ... OK (skipped=1, expected failures=3)
