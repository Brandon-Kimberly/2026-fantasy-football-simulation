...
```bash
py -3.10 -m unittest discover tests      # full suite — 489 tests, must all pass
...
4. **Do not refactor what is not covered by intent.** `run_simulation` (571 lines) and
   `export_and_visualize` (489 lines) ARE pinned byte-exactly by the golden master (Phase 0
