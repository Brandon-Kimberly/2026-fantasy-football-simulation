...
class TestGoldenMaster(unittest.TestCase):
    ...
    # week15 (F3, added in 17cfb69 on 2026-08-29) was listed in golden_master.SCENARIOS -- so it
    # was RUN in setUpClass and REGENERATED by --regenerate -- but never compared: no test below
    # called _compare("week15", ...). Its hashes were computed, committed, and silently ignored
    # for two days, while commit messages cited "12/12, week15 byte-identical" on the strength
    # of explicit fixture diffs rather than of this suite. Found 2026-08-31 while landing F10.
    def test_run_simulation_output_matches_golden_week15(self):
        """Inside-the-playoffs fixture (current_week=15; weeks 1-14 banked, bracket file). Drives
        _seed_from_banked_standings and the weeks_simulated == 0 export branches."""
        self._compare("week15", "stage_a__run_simulation")

    def test_export_output_matches_golden_week15(self):
        self._compare("week15", "stage_b__export_and_visualize")

    def test_export_champ_ranking_matches_golden_week15(self):
        self._compare("week15", "stage_c__export_champ_ranking")
